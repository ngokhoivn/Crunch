...
ACAIController::ACAIController()
{
	...
	SightConfig->SightRadius = 1000.0f; // Bán kính phát hiện
...
void ACAIController::OnPossess(APawn* NewPawn)
{
	...
	// Gọi trực tiếp hàm từ AAIController (không cần cast)
